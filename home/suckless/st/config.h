 ...
 */
static char *font = "BlexMono Nerd Font:pixelsize=18:antialias=true:autohint=true";
static int borderpx = 15;

/* Spare fonts */
static char *font2[] = {
	// "Noto Color Emoji:pixelsize=12:antialias=true:autohint=true", 
	"Material Design Icons Desktop:pixelsize=18:antialias=true:autohint=true", 
	// "BlexMono Nerd Font:pixelsize=18:antialias=true:autohint=true",
};
...
static Key key[] = {
	...
	{ XK_KP_End,        XK_ANY_MOD,     "\033[5~",       0,    0},

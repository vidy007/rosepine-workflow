...
export TYPEWRITTEN_PROMPT_LAYOUT="pure" # singleline/pure/half_pure/multiline
export TYPEWRITTEN_RELATIVE_PATH="adaptive"
#export TYPEWRITTEN_CURSOR="terminal"
#export TYPEWRITTEN_SYMBOL="$"
export TYPEWRITTEN_COLOR_MAPPINGS="secondary:#31748f"
export EDITOR="nvim"
...
compinit
alias smile="flatpak run it.mijorus.smile"
